...
export function PatientLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0] md:flex">
      {/* Desktop sidebar */}
      <aside className="hidden md:flex md:flex-col md:w-64 md:h-screen md:sticky md:top-0 bg-white border-r border-gray-100 shadow-sm">
        <div className="px-4 py-6 border-b border-gray-100 flex items-center justify-center">
          <img
            src={logo}
            alt="Projeto Mentis"
      ...
      {/* Main column */}
      <div className="flex-1 flex flex-col max-w-md mx-auto md:max-w-none md:mx-0 w-full relative">
        {/* Mobile status bar */}
        ...
        {/* Greeting bar */}
        <div className="bg-gradient-to-r from-[#F4A261] to-[#E9C46A] px-6 py-3 md:py-4 flex items-center gap-3">
          <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/30 flex items-center justify-center text-white font-bold text-sm">
            {initials}
          </div>
        ...
        {/* Mobile bottom nav */}
        <nav className="md:hidden fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t border-gray-100 shadow-2xl z-20">
